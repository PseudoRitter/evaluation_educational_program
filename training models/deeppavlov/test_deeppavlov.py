...
print(f"Среднее смещение (Bias): {bias:.4f}")
...
print(f"Медиана абсолютной ошибки: {error_percentiles[0]:.4f}")
print(f"75-й перцентиль абсолютной ошибки: {error_percentiles[1]:.4f}")
print(f"90-й перцентиль абсолютной ошибки: {error_percentiles[2]:.4f}")
print(f"95-й перцентиль абсолютной ошибки: {error_percentiles[3]:.4f}")
